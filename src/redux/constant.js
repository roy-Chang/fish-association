//actionTypes
//weather
export const INIT_WEATHER_ACTION = 'init_weather_action';
export const INIT_WEATHER_INFO_ACTION = 'init_weather_info_action';
...
//products like
export const PRODUCTS_LIKE_ACTION = 'products_like_action';
